...
## Pretraining
### Stage1
The weights of the first stage are saved in output_dir of [train_configsstage1_pretrain.yaml](train_configs/stage1_pretrain.yaml), and you can change it to your own directory
