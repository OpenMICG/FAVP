...
class MiniGPT4(MiniGPTBase):
    ...
    def __init__(
            ...
            device_8bit=0, lora_r=0,lora_alpha=0,setting="",chat_template=False,points_per_side=50,points_per_batch=256,
            ...
            device='cuda',blur_std_dev=100,has_sam=False, vit_lora_r=0, vit_lora_alpha=0
    ):
        super().__init__(
            vit_model=vit_model,
            img_size=img_size,
    ...
    def init_SamMed(
        ...
        sam_model = sam_model_registry["vit_b"](image_size=256,
                                                checkpoint="/data/tongzixuan/checkpoints/sammed/sam-med2d_b.pth",
    ...
    def from_config(cls, cfg):
        ...
        vit_lora_r = cfg.get("vit_lora_r", 0)
        vit_lora_alpha = cfg.get("vit_lora_alpha", 0)
        ...
        model = cls(
            ...
            vit_lora_r=vit_lora_r,vit_lora_alpha=vit_lora_alpha
        )

        ckpt_path = cfg.get("ckpt", "")  # load weights of FAVP
        if ckpt_path:
            print("Load FAVP Checkpoint: {}".format(ckpt_path))
