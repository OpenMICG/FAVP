...
from favp.common.dist_utils import (
...
from favp.common.utils import is_url
from favp.datasets.data_utils import concat_datasets, reorg_datasets_by_split, ChainDataset
from favp.datasets.datasets.dataloader_utils import (
    IterLoader,
    MultiIterLoader,
    PrefetchLoader,
)
    ...
    def eval_epoch(self, split_name, cur_epoch, skip_reload=False):
        ...
        if results is not None:
            return self.task.after_evaluation(
                ...
                epoch=cur_epoch,
                datasets=self.datasets[split_name][0]
            )
